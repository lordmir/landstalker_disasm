;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; LANDSTALKER US BETA ROM 4MByte Expansion ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; BUILDOPTS = /p /o ae-,e+,w+,c+,op+,os+,ow+,oz+,l_ /e REGION=5;NTSC=1;EXPANDED=1;REGION_CHECK=0;FIX_COLL_1=1;FIX_COLL_2=0;FIX_ARMLET_SKIP=0;FIX_WHISTLE_CHECK=0;FIX_SPRITE_HIDE=0;ENABLE_GOLD_COUNT=0;FIX_GOLA_BUG=0;FIX_GOLD_CAP=0;FIX_END_CREDS=0;REFRESH_GOLD_CTR=1;FIX_TS_GLITCH=0
;; REGION = BETA
;;
;; To build, run:
;; .\build\asm68k.exe /p /o ae-,e+,w+,c+,op+,os+,ow+,oz+,l_ /e REGION=5;NTSC=1;EXPANDED=1;REGION_CHECK=0;FIX_COLL_1=1;FIX_COLL_2=0;FIX_ARMLET_SKIP=0;FIX_WHISTLE_CHECK=0;FIX_SPRITE_HIDE=0;ENABLE_GOLD_COUNT=0;FIX_GOLA_BUG=0;FIX_GOLD_CAP=0;FIX_END_CREDS=0;REFRESH_GOLD_CTR=1;FIX_TS_GLITCH=0 landstalker_beta_expanded.asm,landstalker_beta_expanded.bin
