...
Z80AS_OPTS=""
Z80LINK="tools/build/asw/p2bin.exe"
Z80LINK_OPTS="-l 0xff -r 0x0000-0x1f7f -k"
Z80SRC="code/audio/sounddrv.asm"
Z80OBJ="cube.p"
Z80BIN="cube.bin"
REGION="US"
EXPANDED=0
...
echo ${Z80AS} ${Z80SRC} ${Z80AS_OPTS} -o ${Z80OBJ} ${Z80DEFINES}
${Z80AS} ${Z80SRC} ${Z80AS_OPTS} -o ${Z80OBJ} ${Z80DEFINES}
echo ${Z80LINK} ${Z80OBJ} ${Z80BIN} ${Z80LINK_OPTS}
