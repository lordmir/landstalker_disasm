...
Title3:              incbin   "assets_packed\graphics\static\titlescreen\title3_beta.lz77"
...
Title3Map:           incbin   "assets_packed\graphics\static\titlescreen\title3_beta.rle"
                     Align    $00000002
