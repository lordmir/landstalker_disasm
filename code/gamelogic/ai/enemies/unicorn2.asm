Unicorn2	module
; AI for SPR_UNICORN2. As Unicorn1, but more cautious: at the
; stare-down it charges less (51% up front, 50% per re-roll) and it
; dodges the player's swings more often (51%).
...
; around) and the two are facing each other head-on: 51% chance to
...
; $23, BHVS_ADVANCE); if he is mid-swing, 51% chance to dodge (state
...
; pose flip rolls a 50% chance to break into the charge.
_stareDown:
		move.w	CentreX(a5),(g_Scratch1800).l
		move.w	CentreY(a5),(g_Scratch1804).l
		move.w	#$0040,d5
