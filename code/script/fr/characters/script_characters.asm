...
; ---------------------------------------------------------------------------
		dc.w 0			; Params 00, 00
		ScriptJump  CS_0085_1,$1 ; Jump	to address 0x026236
					;
		dc.w 2			; Params 00, 02
...
CS_001B:
		cmpi.w	#01600,(g_Flags+FLAGWORD_GREENPEA_WINNINGS).l
		blt.s	CS_001B_0
		bsr.w	CheckFlagAndDisplayMessage
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
		dc.w $1A		; Params 00, 1A
		ScriptJump  CS_0120_1,$1 ; Jump	to address 0x0270E4
					;
		dc.w $1B		; Params 00, 1B
...
CS_0139_1:
		move.w	#$132,(g_PendingCutsceneAction).l
...
CS_013A_1:
		move.w	#$159,(g_PendingCutsceneAction).l
...
CS_013B_1:
		move.w	#$135,(g_PendingCutsceneAction).l
...
CS_013C_0:
		...
		bsr.w	TestFlagBit
		bne.s	CS_013C_1
		move.w	#$137,(g_PendingCutsceneAction).l
		bra.s	CS_013C_2
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
		...
		ScriptID    $371,$1	; Run text script at offset 0x027FFC
					...
					;
		dc.w $1D		; Params 00, 1D
		ScriptJump  CS_002E_1,$3 ; Jump	to address 0x027354
					;
		dc.w $FFFF
; ---------------------------------------------------------------------------
...
CS_0141:
		move.w	#$138,(g_PendingCutsceneAction).l
		rts
; ---------------------------------------------------------------------------
