...
CS_0139_2:
		move.w	#$0132,(g_PendingCutsceneAction).l
...
CS_013A_2:
		move.w	#$0159,(g_PendingCutsceneAction).l
...
CS_013B_2:
		move.w	#$0135,(g_PendingCutsceneAction).l
...
CS_013C_1:
		...
		bsr.w	TestFlagBit
		bne.s	CS_013C_2
		move.w	#$0137,(g_PendingCutsceneAction).l
		bra.s	CS_013C_3
; ---------------------------------------------------------------------------
...
CS_0141:					  ; CS_0138
		move.w	#$0138,(g_PendingCutsceneAction).l
		rts
; ---------------------------------------------------------------------------
