...
XS_00AC:
		...
		rts
; ---------------------------------------------------------------------------
XS_00AC_Options:ScriptID    $852,$0		  ; Mayor (0x00) : Run text script at offset 0x02889A
...
XS_00AD:
		...
		rts
; ---------------------------------------------------------------------------
XS_00AD_Options:ScriptID    $85A,$0		  ; Mayor (0x00) : Run text script at offset 0x0288AA
						  ; 0x1BED: LOAD SPECIAL CHARACTER * (0x05)
