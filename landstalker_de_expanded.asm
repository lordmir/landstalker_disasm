;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; LANDSTALKER DE ROM 4MByte Expansion ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; BUILDOPTS = /p /o ae-,e+,w+,c+,op+,os+,ow+,oz+,l_ /e REGION=4;NTSC=0;EXPANDED=1;REGION_CHECK=1;FIX_COLL_1=1;FIX_COLL_2=1;FIX_ARMLET_SKIP=1;FIX_WHISTLE_CHECK=1;FIX_SPRITE_HIDE=1;ENABLE_GOLD_COUNT=1;FIX_GOLA_BUG=1;FIX_GOLD_CAP=1;FIX_END_CREDS=0;REFRESH_GOLD_CTR=0;FIX_TS_GLITCH=1
;; REGION = DE
;;
;; To build, run:
;; .\build\asm68k.exe /p /o ae-,e+,w+,c+,op+,os+,ow+,oz+,l_ /e REGION=4;NTSC=0;EXPANDED=1;REGION_CHECK=1;FIX_COLL_1=1;FIX_COLL_2=1;FIX_ARMLET_SKIP=1;FIX_WHISTLE_CHECK=1;FIX_SPRITE_HIDE=1;ENABLE_GOLD_COUNT=1;FIX_GOLA_BUG=1;FIX_GOLD_CAP=1;FIX_END_CREDS=0;REFRESH_GOLD_CTR=0;FIX_TS_GLITCH=1 landstalker_de_expanded.asm,landstalker_de_expanded.bin

Defines:                    include "code/include/landstalker.inc"
                            include "code/include/landstalker_de.inc"
                            ...
                            include "code/system/header_de.asm"
...
IntroStrings:               include "code/text/introstrings_de.asm"
...
InventoryGraphics:          include "code/inventory/graphics_de.asm"
                            Align   $2
...
HuffTableOffsets:           incbin  "assets_packed/strings/main/de/huffmancharoffsets.bin"
HuffTables:                 incbin  "assets_packed/strings/main/de/huffmantables.bin"
                            Align   $2
...
ShopSpecialItemsScript:     include "code/script/de/shops/shoptable_specialitems.asm"
                            include "code/scripthandling/shops/shoppricing.asm"
ShopScript:                 include "code/script/de/shops/shoptable.asm"
                            include "code/scripthandling/scriptfuncs_shopdialogue.asm"
ShopSpecialItemsFuncs:      include "code/script/de/shops/script_shopspecialitems.asm"
...
CutsceneScriptTable:        include "code/script/de/cutscenes/script_cutscenetable.asm"
RoomDialogueTable:          incbin  "assets_packed/roomdata/roomcharatertable.bin"
CharacterScriptTable:       include "code/script/de/characters/script_charactertable.asm"
                            include "code/scripthandling/scriptfuncs_branch.asm"
ShopScriptFuncs:            include "code/script/de/shops/script_shops.asm"
                            include "code/scripthandling/scriptfuncs_church.asm"
CharacterScriptFuncs:       include "code/script/de/characters/script_characters.asm"
CutsceneScriptFuncs:        include "code/script/de/cutscenes/script_cutscenes.asm"
Script:                     incbin  "assets_packed/script/script_de.bin"
...
ItemArticles:               incbin  "assets_packed/script/itemarticles/itemarticles_de.bin"
...
StringTables:               include "code/text/stringtables_de.asm"
...
StringData:                 include "code/text/strings_de.asm"
                            Align   $2
StringBankPtrs:             include "code/pointertables/strings/stringptrs_de.asm"
...
TitleScreen:                include "code/title/titlescreen_de.asm"
...
EndCreditText:              incbin  "assets_packed/strings/ending/credits_de.bin"
                            Align   $2
                            include "code/ending/creditrenderer.asm"
EndCreditsData:             include "code/ending/endcreditsdata_de.asm"
                            Align   $2
