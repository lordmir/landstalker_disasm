...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; BUILDOPTS = /p /o ae-,e+,w+,c+,op+,os+,ow+,oz+,l_ /e REGION=1;NTSC=1;EXPANDED=0;REGION_CHECK=0;FIX_COLL_10;FIX_ARMLET_SKIP=0;FIX_WHISTLE_CHECK=0;FIX_SPRITE_HIDE=0;ENABLE_GOLD_COUNT=0;FIX_GOLA_BUG=0;FIX_GOLD_CAP=0;FIX_END_CREDS=0
;; REGION = JP
;;
;; To build, run:
;; .\build\asm68k.exe /p /o ae-,e+,w+,c+,op+,os+,ow+,oz+,l_ /e REGION=1;NTSC=1;EXPANDED=0;REGION_CHECK=0;FIX_COLL_10;FIX_ARMLET_SKIP=0;FIX_WHISTLE_CHECK=0;FIX_SPRITE_HIDE=0;ENABLE_GOLD_COUNT=0;FIX_GOLA_BUG=0;FIX_GOLD_CAP=0;FIX_END_CREDS=0 landstalker.asm,landstalker.bin
